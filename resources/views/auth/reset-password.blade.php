...
<title>Set Password — TripLedger</title>
...
<body>
  ...
  <div style="width:100%;max-width:420px;">
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:16px;padding:36px;
      ...
      <h2 style="font-size:20px;font-weight:800;color:#111827;margin-bottom:8px;">Set your password</h2>
      <p style="font-size:14px;color:#6b7280;line-height:1.65;margin-bottom:24px;">
        Choose a strong password for your TripLedger account. You'll use it to sign in next time.
      </p>
      ...
      <form method="POST" action="{{ route('password.store') }}">
        ...
        <div style="margin-bottom:16px;">
          <label style="display:block;font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;" for="password">
            New password
          </label>
        ...
        <div style="margin-bottom:24px;">
          <label style="display:block;font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;" for="password_confirmation">
